...
var animeDefinitions = []Definition{
	...
	{Key: "a_first_episode", Name: "First Episode", Description: "Watch your very first anime episode", Category: CategoryAnimeMilestones, MaxTier: 0, Triggers: []EvalTrigger{TriggerEpisodeProgress}},
	...
	{Key: "a_first_complete", Name: "First Completion", Description: "Complete your first anime series", Category: CategoryAnimeMilestones, MaxTier: 0, Triggers: []EvalTrigger{TriggerSeriesComplete}},
	...
	{Key: "a_first_day", Name: "Day One", Description: "Watch anime for the first time on Seanime", Category: CategoryAnimeMilestones, MaxTier: 0, Triggers: []EvalTrigger{TriggerEpisodeProgress}},
	{Key: "a_first_rating", Name: "First Impression", Description: "Rate your first anime", Category: CategoryAnimeMilestones, MaxTier: 0, Triggers: []EvalTrigger{TriggerRatingChange}},
