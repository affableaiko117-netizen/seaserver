...
var mangaDefinitions = []Definition{
	...
	{Key: "m_first_chapter", Name: "First Chapter", Description: "Read your very first manga chapter", Category: CategoryMangaMilestones, MaxTier: 0, Triggers: []EvalTrigger{TriggerChapterProgress}},
	...
	{Key: "m_first_complete", Name: "First Completion", Description: "Complete your first manga series", Category: CategoryMangaMilestones, MaxTier: 0, Triggers: []EvalTrigger{TriggerMangaComplete}},
	...
	{Key: "m_first_day", Name: "Day One Reader", Description: "Read manga for the first time on Seanime", Category: CategoryMangaMilestones, MaxTier: 0, Triggers: []EvalTrigger{TriggerChapterProgress}},
	{Key: "m_first_rating", Name: "First Review", Description: "Rate your first manga", Category: CategoryMangaMilestones, MaxTier: 0, Triggers: []EvalTrigger{TriggerRatingChange}},
